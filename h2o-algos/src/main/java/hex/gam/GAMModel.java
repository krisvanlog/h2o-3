...
public class GAMModel extends Model<GAMModel, GAMModel.GAMParameters, GAMModel.GAMModelOutput> {
  ...
  public static Frame cleanUpInputFrame(Frame adptedF, GAMParameters parms, String[][] gamColNames, double[][][] binvD,
    ...
    Frame tpAugmentedColumns = addTPGamColumns(adptedF, parms, gamColNames, zTransposeCS, zTranspose, polyBasisList, 
            knots);
  ...
  public static Frame addTPGamColumns(Frame adaptedF, GAMParameters parms, String[][] gamColNames, 
                                      double[][][] zTransposeCS, double[][][] zTranspose, int[][][] polyBasisList, 
                                      double[][][] knots) {
